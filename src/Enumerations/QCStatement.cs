...
{
    public sealed class QCStatement : OidDescription
    {
         ...
         */
        public static readonly QCStatement QC_COMPLIANCE = new QCStatement("qc-compliance", "0.4.0.1862.1.1");
         ...
         */
        public static readonly QCStatement QC_LIMIT_VALUE = new QCStatement("qc-limit-value", "0.4.0.1862.1.2");
         ...
         */
        public static readonly QCStatement QC_RETENTION_PERIOD = new QCStatement("qc-retention-period", "0.4.0.1862.1.3");
         ...
         */
        public static readonly QCStatement QC_SSCD = new QCStatement("qc-sscd", "0.4.0.1862.1.4");
         ...
         */
        public static readonly QCStatement QC_PDS = new QCStatement("qc-pds", "0.4.0.1862.1.5");
         ...
         */
        public static readonly QCStatement QCT_ESIGN = new QCStatement("qc-type-esign", "0.4.0.1862.1.6.1");

        public static readonly QCStatement QCT_ESEAL = new QCStatement("qc-type-eseal", "0.4.0.1862.1.6.2");

        public static readonly QCStatement QCT_WEB = new QCStatement("qc-type-web", "0.4.0.1862.1.6.3");
